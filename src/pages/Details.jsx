	...
	return (
		<div className="min-h-screen bg-gray-50 text-gray-800">
			...
			<div className="max-w-[1800px] mx-auto px-4 py-26">
				{/* Main content area */}
				<div className="grid grid-cols-1 lg:grid-cols-3 sm:grid-row-1 gap-30">
					{/* Left side - Image and main content */}
					<div className="lg:col-span-2 px-39">
						{/* Header breadcrumbs */}
						...
						<div className="grid grid-cols-3 gap-10 md:gap-6">
							...
							<div className="col-span-1 ">
								<img 
									src={anime.img} 
									alt={anime.title} 
									className="w-full max-w-[220px] h-[320px] object-cover rounded shadow-lg" 
								/>
							</div>
							...
							{movies.slice(0, 6).map((movie) => (
								<div key={movie.id} className="relative group">
									<img 
										src={movie.img} 
										alt={movie.title} 
										className="w-full h-32 object-cover rounded shadow-md group-hover:blur-2  duration-200" 
									/>
